...
import mx.itam.alpha.common.model.RequestType;
import mx.itam.alpha.common.model.SessionInfo;
...
/**
 * Atiende una conexión TCP persistente de un cliente.
 * Traduce solicitudes JSON a operaciones del servidor y mantiene asociada
 * la sesión autenticada mientras el socket siga abierto.
 */
public class ClientSessionHandler implements Runnable {
    ...
    public void run() {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(socket.getInputStream(), StandardCharsets.UTF_8));
            ...
            while ((line = reader.readLine()) != null) {
                // El protocolo TCP del proyecto es "una petición JSON por línea".
    ...
    private TcpResponse authenticate(TcpRequest request, boolean register) {
        releaseCurrentUser();
        // Tanto REGISTER como LOGIN devuelven la información de sesión necesaria
        // para que el cliente abra sus suscripciones JMS y pueda empezar a jugar.
    ...
    private boolean hasActiveSession() {
        ...
        // Si otra conexión reemplazó la sesión, este handler deja de aceptar operaciones.
    ...
    private PlayerState releaseCurrentUser() {
        ...
        // El release se usa tanto en LOGOUT explícito como en cierres inesperados del socket.
